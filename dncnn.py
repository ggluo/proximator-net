...
class dncnn():
    def __init__(self, chns=2, filter_size=[3,3], nr_layers=5, nr_filters=32, nr_classes=10):
    ...
    def body(self, x, h, nonlinearity, init=False):
        lys = []
    ...
    def main(self, x, h, nonlinearity, init=False):
        out = self.body(x, h, nonlinearity, init)
        self.counters = {}
        return out
